...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final TonLibraryAccessors laccForTonLibraryAccessors = new TonLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at ton
     */
    public TonLibraryAccessors getTon() {
        return laccForTonLibraryAccessors;
    }
    ...
    public static class TonLibraryAccessors extends SubDependencyFactory {

        public TonLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for kotlin (org.ton:ton-kotlin)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKotlin() {
                return create("ton.kotlin");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: tonKotlin (0.2.16)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getTonKotlin() { return getVersion("tonKotlin"); }
