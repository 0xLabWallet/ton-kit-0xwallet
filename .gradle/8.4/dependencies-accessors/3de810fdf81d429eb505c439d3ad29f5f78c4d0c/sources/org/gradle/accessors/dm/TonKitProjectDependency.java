...
@NonNullApi
public class TonKitProjectDependency extends DelegatingProjectDependency {

    @Inject
    public TonKitProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
